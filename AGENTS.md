...
- 直近の動き（2026-09-02）: **memo記事「Enterprise Frontier Safeguards（EFS）とは？」を投稿**（`src/content/memo/enterprise-frontier-safeguards.md`、図3枚はCDN `enterprise-frontier-safeguards/` 配下。Claude Fable 5.1発表に合わせた解説で、Discord #ざっくりメモ のスレッド経由・AI執筆＋レビュー全件反映。drawio原本はdiscord-workspace/tmp-diagrams/efs-*）
