---
title: "【2025年上期ITイベント】興味のあるITイベントをピックアップしてみた"
description: "なお、私の興味のあるキーワードは以下の通りです。- DevOps- Observability- AWS- 生成AI　など..."
pubDate: 2025-01-12
updatedDate: 2025-01-26
tags: []
qiitaId: fee0c9447bc72631485e
...
# はじめに
新卒1年目で、希望すれば（業務の都合がつけば）ITイベントへの参加ができる環境なので、「興味ありそうなのにもう終わってる...」とならないために本記事を作成します。
（興味があるITイベント ≒ 興味があるキーワードを取り扱っているITイベント）
随時更新していきたいと思います。

なお、私の興味のあるキーワードは以下の通りです。
- DevOps
- Observability
- AWS
- 生成AI　など... 
...
主催：日経クロステック
### キーワード
- マイクロサービス・コンテナ・DevOps基盤
- AI・デジタルツイン・データ基盤
- クラウド基盤最適化

# [おこしやす！DevOps×AIで実現する新ステージへ](https://www.intra-mart.jp/seminar/20250221-kansai-event/?event_param=nttdreferralkansai2025nttd_dwp)
日時：2025/2/21(金)
場所：アーバンネット御堂筋ホール
...
# [ObservabilityCON on the Road](https://grafana.com/ja/events/observabilitycon-on-the-road/2025/tokyo/)
日時：2025/2/25(火)
場所：東京ポートシティ竹芝 オフィスタワー1階 ポートホール
主催：Grafana Labs
### キーワード
- Observability
- Grafana

# [DevOpsDays Tokyo 2025](https://confengine.com/conferences/devopsdays-tokyo-2025)
日時：2025/4/15(火)・16(水)
場所：大崎ブライトコアホール・オンライン
主催：confengine（？）
### キーワード
- DevOps

# [@IT 開発変革セミナー 2025春](https://promotion.itmedia.co.jp/plan/2412_16)
日時：2025/6/4(水)～6(金)
場所：オンライン？
主催：@IT
### キーワード
...
# おわりに
正直まだこの手のイベントの調べ方があまりよくわかっていないところではあるので、その点も含めて自分にとって有意義な情報を適切に集めれるようになりたいと思います。

# 参考サイト
- [【2025年上半期】ITフリーランスにおすすめのTECHイベント情報](https://geechs-job.com/tips/details/200)
- [【2025年1月〜6月開催】IT・DX関連の展示会まとめ](https://www.techfirm.co.jp/blog/events-2025firsthalf)
